...
#ifdef FIRSTPERSONVIEW
#define UNITY_MATRIX_P _firstPersonProjectionMatrix // FPV change
#define UNITY_MATRIX_V unity_MatrixV
#define UNITY_MATRIX_I_V unity_MatrixInvV
#define UNITY_MATRIX_VP mul(UNITY_MATRIX_P, UNITY_MATRIX_V) // FPV change
...
static float4x4 unity_MatrixMVP = mul(UNITY_MATRIX_VP, unity_ObjectToWorld);
static float4x4 unity_MatrixMV = mul(UNITY_MATRIX_V, unity_ObjectToWorld);
